...
public class Example_402 {
	...
	public static void main(String[] args) {
		...
		//JOptionPane.showMessageDialog(null, "Your e-mail is " + (inputEmail.endsWith("@gmail.com")||inputEmail.endsWith("@hotmail.com")?inputEmail:"not hotmail or gmail dot com"));
